<template>
    ...
    <div class="form-container sign-up-container">
      <form>
        ...
        <input type="text" placeholder="Fullname" name="user_fullname" v-model="user_fullname"/>
...
.container {
  ...
  border-radius: 10px;
  box-shadow: 14px 2px 28px #3ec5ffdf;
  position: relative;
  overflow: hidden;
  width:850px;
  height: 650px;
...
.overlay {
  background:#3ec5ffdf;
  background: linear-gradient(to right, #3ec5ffdf);
